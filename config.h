...
=======
    "black", /* 256 -> bg */
    "green", /* 257 -> fg */
>>>>>>> 59b29d293d28a71132eecd25164ddc12a47fa7c7
};
...
static char *openurlcmd[] = {
    ...
    "'s/^www./http:\\/\\/www\\./g' | dmenu -w $(xdotool getactivewindow) -i -p "
    "'Follow which url?' -l 10 | xargs -r xdg-open",
    "externalpipe", NULL};
